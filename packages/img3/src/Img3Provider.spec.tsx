  ...
  it('should render img with the default gateway from Img3 provider', async function () {
    ...
    render(
      <Img3Provider defaultGateways={['https://nftstorage.link/ipfs/']}>
        <Img3 src={'ipfs://bafkreidpunfemg2foalobiurfob4v6rdb4i3fmujvj5lpnzahfo3a4mxmy'} />
      </Img3Provider>
    );
    await act(() => sleep(500));
    expect(screen.getByRole('img').getAttribute('src')).toBe(
      'https://bafkreidpunfemg2foalobiurfob4v6rdb4i3fmujvj5lpnzahfo3a4mxmy.ipfs.nftstorage.link/'
    );
  });
});
